...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 04, 2025 at 06:13 PM
...
(43, 'Keune So Pure Color Care Shampoo (250ml)', 'A great color treatment is a work of art – and we want it to stay beautiful long after leaving the salon. It all begins with the right shampoo. So Pure Color Care Shampoo is sulfate-free – and gently cleanses, hydrates and nourishes, while keeping color sealed into each and every strand of hair.', 2999.00, 9, 'Keune So Pure Color Care Shampoo.png', '2025-07-04 11:32:31', 3),
...
(45, 'Keune So Pure Moisturizing Shampoo (250ml)', 'As in nature, healthy hair is all about balance. We formulated So Pure Moisturizing Shampoo with organic plant-based ingredients to oh-so-gently restore hair and scalp hydration. Our Moisturizing Shampoo is safe to use on color treated hair, and contains no sulfates – leaving hair soft and shiny without stripping hair’s natural oils', 8999.00, 7, 'Keune So Pure Moisturizing shampoo.png', '2025-07-04 11:40:11', 3),
(46, 'Keune So Pure Recover Shampoo (250ml)', 'Lifeless, brittle hair doesn’t need to be sheared away. Repair it! A gentle So Pure Recover salon treatment is a great first step. Keep up the good work at home with So Pure Recover Shampoo – and let the organic essential oils and plant extracts restore hair to its naturally shiny, healthy fabulousness.', 3499.00, 6, 'Keune So Pure Recover Shampoo.png', '2025-07-04 11:41:34', 3),
...
(48, 'pH Argan Keratin Shampoo (200ml)', 'Deeply moisturises hair leaving it stronger, shiny and soft.', 5500.00, 8, 'pH Argan Keratin Shampoo.png', '2025-07-04 11:45:03', 3),
